...
In the same directory as the variables file, create another file named main.tf. In this file, we define the main infrastructure resources and configurations for our Terraform project.
